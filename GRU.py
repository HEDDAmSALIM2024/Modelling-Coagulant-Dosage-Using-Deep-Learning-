...
# Les 10 premières colonnes sont les caractéristiques et la dernière colonne est la cible (Q(t))
...
model.add(GRU(50, dropout=0.1, recurrent_dropout=0.1,return_sequences=False, input_shape=(10, 1)))  # 6 étapes de temps, 1 caractéristique par étape
model.add(Dense(1))
